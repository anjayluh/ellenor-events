...
with package_grants(package_code, entitlement_key, scope, value_type, quantity, duration_days, metadata) as (
  values
    ('starter-event', 'events', 'ACCOUNT', 'QUANTITY', 1, null, '{"provisional": true}'::jsonb),
    ('starter-event', 'guests_per_event', 'EVENT', 'QUANTITY', 150, null, '{"provisional": true}'::jsonb),
    ('starter-event', 'collaborators_per_event', 'EVENT', 'QUANTITY', 6, null, '{"provisional": true}'::jsonb),
    ('starter-event', 'vendors_per_event', 'EVENT', 'QUANTITY', 5, null, '{"provisional": true}'::jsonb),
    ('starter-event', 'budget_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('starter-event', 'rsvp_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('starter-event', 'meeting_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('starter-event', 'task_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'events', 'ACCOUNT', 'QUANTITY', 1, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'guests_per_event', 'EVENT', 'QUANTITY', 400, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'collaborators_per_event', 'EVENT', 'QUANTITY', 20, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'vendors_per_event', 'EVENT', 'QUANTITY', 20, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'budget_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'rsvp_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'vendor_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'meeting_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('family-coordination', 'task_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'events', 'ACCOUNT', 'QUANTITY', 3, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'guests_per_event', 'EVENT', 'QUANTITY', 600, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'collaborators_per_event', 'EVENT', 'QUANTITY', 35, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'vendors_per_event', 'EVENT', 'QUANTITY', 30, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'budget_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'rsvp_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'vendor_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'meeting_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('multi-event-planner', 'task_management', 'ACCOUNT', 'BOOLEAN', null, null, '{"provisional": true}'::jsonb),
    ('extra-event', 'events', 'ACCOUNT', 'QUANTITY', 1, null, '{"provisional": true, "add_on": true}'::jsonb),
    ('extra-guests', 'guests_per_event', 'EVENT', 'QUANTITY', 100, null, '{"provisional": true, "add_on": true}'::jsonb),
    ('extra-collaborators', 'collaborators_per_event', 'EVENT', 'QUANTITY', 5, null, '{"provisional": true, "add_on": true}'::jsonb)
)
